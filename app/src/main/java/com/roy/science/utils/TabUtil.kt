...
object TabUtil {
    fun openCustomTab(url: String, pkgManager: PackageManager, context: Context) {
        ...
        customTabBuilder.setToolbarColor(ContextCompat.getColor(context, com.roy.science.R.color.colorLightPrimary))
        customTabBuilder.setSecondaryToolbarColor(ContextCompat.getColor(context, com.roy.science.R.color.colorLightPrimary))
