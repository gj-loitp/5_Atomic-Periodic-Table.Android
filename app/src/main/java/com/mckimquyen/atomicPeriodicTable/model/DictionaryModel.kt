    ...
    fun getList(dictionary: ArrayList<Dictionary>) {
        ...
        dictionary.add(
            Dictionary(
                ...
                "Ionization energy",
                "In physics and chemistry, ionization energy (American English spelling) or ionisation energy (British English spelling), denoted Ei, is the minimum amount of energy required to remove the most loosely bound electron, the valence electron, of an isolated neutral gaseous atom or molecule.",
        ...
        dictionary.add(
            Dictionary(
                category = "physics",
                heading = "Enthalpy of fusion",
                text = "The enthalpy of fusion of a substance, also known as (latent) heat of fusion is the change in its enthalpy resulting from providing energy, typically heat, to a specific quantity of the substance to change its state from a solid to a liquid, at constant pressure.",
        ...
        dictionary.add(
            Dictionary(
                "chemistry",
                "Chemical element",
                "In chemistry, an element is a pure substance which cannot be broken down by chemical means, consisting of atoms which have identical numbers of protons in their atomic nuclei. The number of protons in the nucleus is the defining property of an element, and is referred to as the atomic number (represented by the symbol Z). Chemical elements constitute all of the baryonic matter of the universe.",
        ...
        dictionary.add(
            Dictionary(
                "chemistry, physics",
                "Proton",
                "A proton is a subatomic particle with a positive electric charge of +1e elementary charge and a mass slightly less than that of a neutron.",
        ...
        dictionary.add(
            Dictionary(
                "chemistry, physics",
                "Neutron",
                "The neutron is a subatomic particle with no electric charge and a mass slightly greater than that of a proton",
        ...
        dictionary.add(
            Dictionary(
                "chemistry",
                "Functional Group",
                "In organic chemistry, functional groups are specific substituents or moieties within molecules that may be responsible for the characteristic chemical reactions of those molecules.",
        ...
        dictionary.add(
            Dictionary(
                "physics",
                "Magnetic Field",
                "A magnetic field is a vector field (more precisely a pseudovector field) that describes the magnetic influence of electric charges in relative motion and magnetized materials.",
        ...
        dictionary.add(
            Dictionary(
                "physics",
                "Vacuum",
                "Vacuum is space devoid of matter. The word stems from the Latin adjective vacuus for \"vacant\" or \"void\". An approximation to such vacuum is a region with a gaseous pressure much less than atmospheric pressure.",
